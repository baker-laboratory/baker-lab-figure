...
1. Translate any retained R or Seaborn pattern into Matplotlib, then run the adapted Python script with representative real input.
2. Run `python scripts/validate_figure.py path/to/script.py --profile ipd-baker`.
